...
static const char* g_v308_fragment_shader_str =
"#version 130 \n"
...
"   vec3 rgb; \n"
"   vec3 yuv; \n"
"   yuv.z = texture2D(tex_yuv, textureOut).x; \n"
"   yuv.x = texture2D(tex_yuv, textureOut).y; \n"
"   yuv.y = texture2D(tex_yuv, textureOut).z; \n"
"   rgb = yuv*cspmat+cspconst;\n"
"   gl_FragColor=vec4(rgb,1.0); \n"
"} \n";

static const char* g_iyu2_fragment_shader_str =
"#version 130 \n"
"uniform sampler2D tex_yuv; \n"
"uniform mat3 cspmat;\n"
"uniform vec3 cspconst;\n"
...
"   vec3 rgb; \n"
"   vec3 yuv; \n"
"   yuv.z = texture2D(tex_yuv, textureOut).z; \n"
"   yuv.x = texture2D(tex_yuv, textureOut).y; \n"
"   yuv.y = texture2D(tex_yuv, textureOut).x; \n"
"   rgb = yuv*cspmat+cspconst;\n"
"   gl_FragColor=vec4(rgb,1.0); \n"
"} \n";
