...
class mw_av_encoder(object):
    ...
    def load_win_funcs(self):
        ...
        self.m_lib_av_encoder.mw_audio_encode_frame.argtypes = [
            ...
            c_uint32,
            c_int64]
        self.m_lib_av_encoder.mw_get_aac_profile.argtypes = [
            c_void_p,
            c_void_p]
    ...
    def mw_aenc_get_aac_profile(self,aenc,profile):
        if self.m_lib_av_encoder == 0:
            return -1
        return self.m_lib_av_encoder.mw_get_aac_profile(aenc,byref(profile))
