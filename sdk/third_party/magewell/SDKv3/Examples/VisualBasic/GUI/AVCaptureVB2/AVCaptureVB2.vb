...
Public Class AVCaptureVB2
    ...
    Protected m_nWidth As Integer = 720
    Protected m_nHeight As Integer = 480
    ...
    Protected Sub SetStatusBarInfo()
        ...
        strFps = "720x480 BGRA " + m_hThread.GetCurrentFPS()
    ...
    Private Sub AboutAVCaptureVB2ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AboutAVCaptureVB2ToolStripMenuItem.Click
        MsgBox("AVCapture,Version 2.0" & vbCrLf & "Copyright(C) 2011-2020,Nanjing Magewell Electronics Co., Ltd." & vbCrLf & "All rights reserved.", vbInformation)
    End Sub
End Class
