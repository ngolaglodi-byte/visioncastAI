...
set path_file_manifest=manifest\AVCapture2\MANIFEST.MF
...
set history_path=%cd%
cd %path_dir_folder%
jar cvfm AVCapture2.jar MANIFEST.MF -C %dir_file%/ .

cd %history_path%
copy %path_dir_folder%\AVCapture2.jar ..\..\..\Bin\x64\Release

cd ..\..\..\Bin\x64\Release
java -jar ..\..\..\Bin\x64\Release\AVCapture2.jar