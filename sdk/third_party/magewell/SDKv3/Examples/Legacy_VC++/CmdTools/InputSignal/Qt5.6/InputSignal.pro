...
win32:CONFIG(debug,debug|release){
    TARGET=InputSignalQTd
    if(contains(ARCHITECTURE,x86)){
        DESTDIR_TARGET = $$PWD/../../../../../Bin/Win32/Debug/InputSignalQTd
        MOC_DIR = $$PWD/../../../../../Temp/Win32/Debug
        LIBS += $$PWD/../../../../../Lib/Win32/LibMWCaptured.lib
    } else {
        DESTDIR_TARGET = $$PWD/../../../../../Bin/x64/Debug/InputSignalQTd
        MOC_DIR = $$PWD/../../../../../Temp/x64/Debug
        LIBS += $$PWD/../../../../../Lib/x64/LibMWCaptured.lib
    }
}
else:win32:CONFIG(release,debug|release){
    TARGET=InputSignalQT
    if(contains(ARCHITECTURE,x86)){
        DESTDIR_TARGET = $$PWD/../../../../../Bin/Win32/Release/InputSignalQT
        MOC_DIR = $$PWD/../../../../../Temp/Win32/Release
        LIBS += $$PWD/../../../../../Lib/Win32/LibMWCapture.lib
    } else {
        DESTDIR_TARGET = $$PWD/../../../../../Bin/x64/Release/InputSignalQT
