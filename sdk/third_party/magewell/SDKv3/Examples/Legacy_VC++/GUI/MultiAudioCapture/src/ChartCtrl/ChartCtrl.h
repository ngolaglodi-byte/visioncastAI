...
public:
	...
	**/
	void RemoveSerie(size_t uSerieId);
	...
	**/
	void RemoveCursor(size_t cursorId);
...
private:
	...
	**/
	...
	typedef std::map<size_t, CChartSerie*> TSeriesMap;
	...
	typedef std::map<size_t, CChartCursor*> TCursorMap;
